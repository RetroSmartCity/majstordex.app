      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 text-gray-800">
        ...
        <section className="mb-12 text-lg leading-relaxed">
          <p>
            ...
            nudi brzu i pouzdanu popravku bojlera svih modela – <strong>dolazak u roku od 60-90 minuta</strong>,
            radimo 24/7 i pokrivamo sva beogradska naselja.
          </p>
          <p className="mt-4">
            Najčešći problemi koje rešavamo uključuju:
          </p>
          ...
          <p className="mt-4">
            ...
            Ariston, Termor, Gorenje, Tesla, Metalac, Bosch i druge marke.
            Na licu mesta vršimo <strong>dijagnostiku, popravku i zamenu delova</strong>.
          </p>
          <p className="mt-4">
            Pozovite nas odmah i rešite kvar u najkraćem roku! Radimo i vikendom i praznicima,
            a <strong>garancija na ugrađene delove i rad</strong> je uključena u cenu.
          </p>
        </section>
