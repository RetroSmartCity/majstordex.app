  ...
  return (
    <section className="bg-slate-900 text-white pt-24 pb-24 md:pt-32 md:pb-32">
      <div className="max-w-3xl mx-auto px-4 text-center">
        ...
        {/* GLAVNI NASLOV – stabilna verzija */}
        <h1 className="text-4xl md:text-5xl font-extrabold leading-tight mb-6 tracking-tight">
          Električar Beograd 0–24
        </h1>

        {/* PODNASLOV */}
        <div className="text-base md:text-lg text-slate-200 space-y-2 mb-8 leading-relaxed">
          <p>
          ...
          <p>Najbolje ocenjen električar u Beogradu.</p>
          <p>
            <span className="font-semibold text-yellow-300">
              Preko 800 pozitivnih recenzija
            </span>
            .
          </p>
        </div>
        ...
        <div className="flex flex-col items-center gap-4">
          <a
            ...
            className="inline-flex items-center justify-center bg-yellow-400 text-slate-900 font-semibold 
                       px-8 py-3 rounded-full text-base md:text-lg shadow-lg shadow-yellow-500/30 hover:bg-yellow-300 
                       hover:shadow-yellow-400/40 active:scale-[0.98] transition-all duration-200"
          >
