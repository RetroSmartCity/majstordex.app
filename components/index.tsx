      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-10 sm:py-12 text-gray-800">
        ...
        <section className="max-w-xl mx-auto text-center mb-16">
          ...
          <p className="text-lg mb-2">
            📞{" "}
            <a href="tel:+381641234567" className="text-blue-600 font-semibold hover:underline">
              064 123 4567
            </a>
          </p>
          <p className="text-lg">
            ✉️{" "}
            <a href="mailto:info@majstordex.rs" className="text-blue-600 font-semibold hover:underline">
              info@majstordex.rs
            </a>
          </p>
        </section>
